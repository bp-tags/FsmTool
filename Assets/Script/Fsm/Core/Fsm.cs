...
namespace GameFramework.Fsm
{
    ...
    internal sealed class Fsm<T> : FsmBase, IFsm<T> where T : class
    {
        ...
        private readonly IDictionary<string, object> m_Datas;
            ...
            : base(name)
        {
            if (owner == null)
            {
                throw new UnityEngine.UnityException("FSM owner is invalid.");
            }

            if (states == null || states.Length < 1)
            {
                throw new UnityEngine.UnityException("FSM states is invalid.");
            }
            ...
            foreach (FsmState<T> state in states)
            {
                ...
                {
                    throw new UnityEngine.UnityException(string.Format("FSM '{0}' state '{1}' is already exist.", name, stateName));
                }
        ...
        public void Start(Type stateType)
        {
            if (IsRunning)
            {
                throw new UnityEngine.UnityException("FSM is running, can not start again.");
            }

            FsmState<T> state = GetState(stateType);
            if (state == null)
            {
                throw new UnityEngine.UnityException(string.Format("FSM '{0}' can not start state '{1}' which is not exist.", Name, stateType.FullName));
            }
        ...
        public void FireEvent(object sender, int eventId)
        {
            if (m_CurrentState == null)
            {
                throw new UnityEngine.UnityException("Current state is invalid.");
            }
        ...
        public bool HasData(string name)
        {
            ...
            {
                throw new UnityEngine.UnityException("Data name is invalid.");
            }
        ...
        internal void ChangeState(Type stateType)
        {
            ...
            if (state == null)
            {
                throw new UnityEngine.UnityException(string.Format("FSM '{0}' can not change state to '{1}' which is not exist.", Name, stateType.FullName));
            }
